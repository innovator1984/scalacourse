...
import FloatOps._
  ...
  test("Fork.insert pos 01") {
    // TODO 2.E Data Structures
    assert(true)
  }

  test("Fork.insert neg 01") {
    // TODO 2.E Data Structures
    assert(true)
  }
  ...
  test("Quad.mass pos 01") {
    // TODO 2.G Data Structures
    assert(true)
  }

  test("Quad.mass neg 01") {
    // TODO 2.G Data Structures
    assert(true)
  }

  test("Quad.total pos 01") {
    // TODO 2.H Data Structures
    assert(true)
  }

  test("Quad.total neg 01") {
    // TODO 2.H Data Structures
    assert(true)
  }

  test("Quad.insert pos 01") {
    // TODO 2.I Data Structures
    assert(true)
  }

  test("Quad.insert neg 01") {
    // TODO 2.I Data Structures
    assert(true)
  }

  test("Body.updated pos 01") {
    // TODO 3.A Data Structures
    assert(true)
  }

  test("Body.updated neg 01") {
    // TODO 3.A Data Structures
    assert(true)
  }

  test("Boundaries pos 01") {
    // TODO 4.A The Sector Matrix
    assert(true)
  }

  test("Boundaries neg 01") {
    // TODO 4.A The Sector Matrix
    assert(true)
  }

  test("SectorMatrix pos 01") {
    // TODO 4.B The Sector Matrix
    assert(true)
  }

  test("SectorMatrix neg 01") {
    // TODO 4.B The Sector Matrix
    assert(true)
  }
  ...
  test("SectorMatrix.combine pos 01") {
    // TODO 4.D The Sector Matrix
    assert(true)
  }

  test("SectorMatrix.combine neg 01") {
    // TODO 4.D The Sector Matrix
    assert(true)
  }

  test("SectorMatrix.toQuad pos 01") {
    // TODO 4.E The Sector Matrix
    assert(true)
  }

  test("SectorMatrix.toQuad neg 01") {
    // TODO 4.E The Sector Matrix
    assert(true)
  }

  test("Simulator.step pos 01") {
    // TODO 5.A The Sector Matrix
    assert(true)
  }

  test("Simulator.step neg 01") {
    // TODO 5.A The Sector Matrix
    assert(true)
  }

  test("Simulator.computeBoundaries pos 01") {
    // TODO 6.A Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.computeBoundaries neg 01") {
    // TODO 6.A Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.computeSectorMatrix pos 01") {
    // TODO 6.B Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.computeSectorMatrix neg 01") {
    // TODO 6.B Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.updateBodies pos 01") {
    // TODO 6.C Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.updateBodies neg 01") {
    // TODO 6.C Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.updateBoundaries pos 01") {
    // TODO 6.D Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.updateBoundaries neg 01") {
    // TODO 6.D Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.mergeBoundaries pos 01") {
    // TODO 6.E Computing the Scene Boundaries
    assert(true)
  }

  test("Simulator.mergeBoundaries neg 01") {
    // TODO 6.E Computing the Scene Boundaries
    assert(true)
  }
}
