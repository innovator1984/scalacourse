...
class BlurSuite extends FunSuite {
  ...
  test("boxBlurKernel pos 01") {
    // TODO 2.A The Box Blur Filter Kernel
    assert(true)
  }

  test("boxBlurKernel neg 01") {
    // TODO 2.A The Box Blur Filter Kernel
    assert(true)
  }

  test("VerticalBoxBlur.blur pos 01") {
    // TODO 3.A Vertical Stripping Box Blur
    assert(true)
  }

  test("VerticalBoxBlur.blur neg 01") {
    // TODO 3.A Vertical Stripping Box Blur
    assert(true)
  }

  test("VerticalBoxBlur.parBlur pos 01") {
    // TODO 3.B Vertical Stripping Box Blur
    assert(true)
  }

  test("VerticalBoxBlur.parBlur neg 01") {
    // TODO 3.B Vertical Stripping Box Blur
    assert(true)
  }

  test("HorizontalBoxBlur.blur pos 01") {
    // TODO 4.A Vertical Stripping Box Blur
    assert(true)
  }

  test("HorizontalBoxBlur.blur neg 01") {
    // TODO 4.A Vertical Stripping Box Blur
    assert(true)
  }

  test("HorizontalBoxBlur.parBlur pos 01") {
    // TODO 4.B Vertical Stripping Box Blur
    assert(true)
  }

  test("HorizontalBoxBlur.parBlur neg 01") {
    // TODO 4.B Vertical Stripping Box Blur
    assert(true)
  }
}
