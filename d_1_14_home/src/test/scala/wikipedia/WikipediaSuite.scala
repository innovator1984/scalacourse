...
class WikipediaSuite extends FunSuite with BeforeAndAfterAll {
  ...
  test("occurrencesOfLang pos 01") {
    // TODO 3.A Read-in Wikipedia Data
    assert(true)
  }

  test("occurrencesOfLang neg 01") {
    // TODO 3.A Read-in Wikipedia Data
    assert(true)
  }

  test("rankLangs pos 01") {
    // TODO 3.B Read-in Wikipedia Data
    assert(true)
  }

  test("rankLangs neg 01") {
    // TODO 3.B Read-in Wikipedia Data
    assert(true)
  }

  test("makeIndex pos 01") {
    // TODO 3.C Read-in Wikipedia Data
    assert(true)
  }

  test("makeIndex neg 01") {
    // TODO 3.C Read-in Wikipedia Data
    assert(true)
  }

  test("rankLangsUsingIndex pos 01") {
    // TODO 3.D Read-in Wikipedia Data
    assert(true)
  }

  test("rankLangsUsingIndex neg 01") {
    // TODO 3.D Read-in Wikipedia Data
    assert(true)
  }

  test("rankLangsReduceByKey pos 01") {
    // TODO 3.E Read-in Wikipedia Data
    assert(true)
  }

  test("rankLangsReduceByKey neg 01") {
    // TODO 3.E Read-in Wikipedia Data
    assert(true)
  }
}
