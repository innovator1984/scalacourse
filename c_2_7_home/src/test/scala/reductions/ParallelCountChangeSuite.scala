...
class ParallelCountChangeSuite extends FunSuite {
  ...
  // ===== MY TESTS N_2 =====
  test("countChange pos 01") {
    // TODO 2.A Parallel Counting Change
    assert(true)
  }

  test("countChange neg 01") {
    // TODO 2.A Parallel Counting Change
    assert(true)
  }

  test("parCountChange pos 01") {
    // TODO 2.B Parallel Counting Change
    assert(true)
  }

  test("parCountChange neg 01") {
    // TODO 2.B Parallel Counting Change
    assert(true)
  }

  test("moneyThreshold pos 01") {
    // TODO 2.C Parallel Counting Change
    assert(true)
  }

  test("moneyThreshold neg 01") {
    // TODO 2.C Parallel Counting Change
    assert(true)
  }

  test("totalCoinsThreshold pos 01") {
    // TODO 2.D Parallel Counting Change
    assert(true)
  }

  test("totalCoinsThreshold neg 01") {
    // TODO 2.D Parallel Counting Change
    assert(true)
  }

  test("combinedThreshold pos 01") {
    // TODO 2.E Parallel Counting Change
    assert(true)
  }

  test("combinedThreshold neg 01") {
    // TODO 2.E Parallel Counting Change
    assert(true)
  }
}
